...
//    方便数组转换成list，用对象toString方法
    ...
    public static void setFileIcon(ImageView view, String fileName,String filePath) {
        ...
        String end = fileName.substring(fileName.lastIndexOf(".") + 1,
                fileName.length());
        if ((end == null)) {
            view.setImageResource(R.mipmap.vim_file_icon_unknow);
            return;
        } else {
            end = end.toLowerCase();
        }
        ...
        if (end.equals("jpg") || end.equals("gif") || end.equals("png") || end.equals("jpeg") || end.equals("bmp")) {
            ...
            view.setImageResource(R.mipmap.vim_file_icon_apk);
        } else if (end.equals("exe")) {
            view.setImageResource(R.mipmap.vim_file_icon_exe);
        } else if (end.startsWith("xls")) {
            view.setImageResource(R.mipmap.vim_file_icon_excel);
        } else if (end.startsWith("doc") || end.equals("rtf")) {
            view.setImageResource(R.mipmap.vim_file_icon_doc);
        } else if (end.equals("rar") || end.equals("zip") || end.equals("gz") || end.equals("tar")) {
            view.setImageResource(R.mipmap.vim_file_icon_rar);
        } else if (end.equals("txt") || end.equals("log")) {
            view.setImageResource(R.mipmap.vim_file_icon_txt);
                ...
                || end.equals("mov")) {
            view.setImageResource(R.mipmap.vim_file_icon_asf);
        } else if (end.equals("mp3") || end.equals("wav") || end.equals("ra") || end.equals("ram") || end.equals("amr")) {
            view.setImageResource(R.mipmap.vim_file_icon_aiff);
        } else if (end.equals("ppt")) {
            view.setImageResource(R.mipmap.vim_file_icon_bat);
        } else if (end.equals("bat")) {
            view.setImageResource(R.mipmap.vim_file_icon_bat);
        } else if (end.equals("dll")) {
            view.setImageResource(R.mipmap.vim_file_icon_dll);
        } else if (end.equals("html")) {
            view.setImageResource(R.mipmap.vim_file_icon_html);
        } else if (end.equals("pdf")) {
            view.setImageResource(R.mipmap.vim_file_icon_pdf);
        } else {
            view.setImageResource(R.mipmap.vim_file_icon_unknow);
        }
    }
